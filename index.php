...
<!--
        <section class="hero home_hero">
            <div class="container-fluid">
                <img src="img/peace-of-mind.png" alt="">
                <p>Sometimes retirement consists of traveling and tee times.<br>
                Other times it's simply making sure you're going to be ok.</p>
                <p>We'll help you make the most of your retirement<br>so you can rest easy.</p>
            </div>
        </section>
-->
        ...
        <section class="head">
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span6">
                        <article class="service">
                            <a href="./investment-management.php" title="Investment Management" class="circle big im">
                    ...
                    <div class="span6">
                        <article class="service">
                            <a href="./retirement-planning.php" title="Retirement Planning" class="circle big rp">
                                <div class="circle_inner"></div>
                            </a>
                ...
                <div class="view_services_wrapper">
                    <a href="./services.php" title="" class="view_services">View Services</a>
                </div>
            </div>
        </section>
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <blockquote class="testimonial">
                            <div class="quote">
                                "My wife and I appreciate your professional service and caring, personal touch.  We can’t imagine working with anyone else"
                            </div>
                            <cite>Mike, Retired UAL Captain</cite>
                        </blockquote>
                    </div>
                    <div class="span4">
                        <blockquote class="testimonial">
                            <div class="quote">
                                "I feel I can sleep at night with your firm watching my money."
                            </div>
                            <cite>Dan, Active DAL Captain</cite>
                        </blockquote>
                    </div>
                    <div class="span4">
                        <blockquote class="testimonial">
                            <div class="quote">
                                "I really appreciate all the extra things you do...Total Investment Management really ROCKS!"
                            </div>
                            <cite>Billie Jean, Retired Alaska Flight Attendant</cite>
                        </blockquote>
                    </div>
                </div>
            </div>
