...
<html>
    <head>
        ...
        <title>Can You Have the Retirement You Want?</title>
        <meta name="description" content="Your retirement savings determine the timing and quality of your retirement. TIM’s process positions aviation pros for success in retirement.">
            ...
            <div class="row-fluid">
              <div class="span8 offset2">
                ...
                <div class="education-article__content">
                  <h1 class="education-article__heading">Can You Have the Retirement You Want?</h1>
                ...
                <div class="row-fluid">
                  <div class="span10 offset1">
                    ...
                    <ul class="education-article__related-list">
                        ...
                        <li class="education-article__related-list-item">
                          <a class="education-article__related-link  current " href="/education/retirement-you-want.php" title="">Can You Have the Retirement You Want?</a>
                        </li>
