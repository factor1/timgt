...
// next posts and prev posts with class
add_filter('next_posts_link_attributes', 'posts_link_attributes_next');
add_filter('previous_posts_link_attributes', 'posts_link_attributes_prev');

function posts_link_attributes_prev() {
    return 'class="button left"';
}
function posts_link_attributes_next() {
    return 'class="button next"';
}


// next post and prev post with class
...
function post_link_attributes_next($output) {
    return str_replace('<a href=', '<a class="button left" href=', $output);
}
...
function custom_password_form() {
	...
	<label for="' . $label . '">' . __( "Password:" ,'bonestheme') . ' </label><input name="post_password" id="' . $label . '" type="password" size="20"><input type="submit" name="Submit" value="' . esc_attr__( "Submit",'bonestheme' ) . '" /></form></div>';
	return $o;
}
...
function new_excerpt_more( $more ) {
  ...
  return '<br><br><a href="' . get_permalink( get_the_ID() ) . '" class="button blog_continue">Continue</a>';
}
